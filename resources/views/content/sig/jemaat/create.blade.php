...
@section('title', 'Tambah Jemaat - SIG GMIM')
    ...
    <div class="card-body">
      <form action="{{ route('jemaat.store') }}" method="POST">
        ...
        <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="jumlah_anggota" name="jumlah_anggota"
                    value="{{ old('jumlah_anggota', 1) }}" min="1" required>
                </div>
              </div>
            </div>
            <div class="mb-3">
          ...
          <div class="col-md-6">
            <div class="mb-3">
              <label class="form-label">Lokasi (Klik peta untuk memilih) <span class="text-danger">*</span></label>
              <div id="map"></div>
            </div>
            <div class="row">
              <div class="col-md-6">
...
@section('page-script')
  ...
  <script>
    // Default ke Manado
    var map = L.map('map').setView([1.4748, 124.8421], 13);
    var marker;
